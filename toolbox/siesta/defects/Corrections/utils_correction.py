...
def fit_energies(dimensions_dict, energies_dict,epsilon):
    """
    ...
    def fitting_func(x, a, b, c):
        ...
        a,b,c: Float
            Parameters to fit
        """
        #return a * x*epsilon**-1 + b * x**3*epsilon**-1 + c
        #return a * x + b * x**3  +  c
        return a * x +  c
...
"""
def fit_energies_original(dimensions_dict, energies_dict):
    """
    Fit the model energies
