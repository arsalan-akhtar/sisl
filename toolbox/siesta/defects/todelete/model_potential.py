...
from ..Utils.utils_model_potential import get_model_potential,get_cell_matrix , get_reciprocal_cell,get_energy,get_model_potential_cutoff
...
class ModelPotential():
    ...
    def compute_model_potential(self):
        ...
        if self.use_siesta_mesh_cutoff:
            ...
            self.model_potential = get_model_potential_cutoff ( self.r_cell,
                                                dimensions= self.grid[self.scale_factor],
                                                charge_density= self.charge_density[self.scale_factor],
                                                epsilon=self.epsilon
                                               )
